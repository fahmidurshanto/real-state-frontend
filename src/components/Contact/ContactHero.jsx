...
const ContactHero = () => {
  return (
    <section className="flex flex-col relative min-h-[678px] w-[calc(100%-40px)] max-w-full overflow-hidden items-center justify-center mx-5 mt-20 px-2.5 py-[271px] rounded-[30px] max-md:mt-10 max-md:py-[100px]">
      <img
